# nx-task-running Specification

## Purpose
TBD - created by syncing change add-nx. Covers running, caching, and orchestrating workspace tasks (build, test, serve) through Nx, including cache invalidation on source changes, unchanged-input cache hits, and keeping the pre-Nx npm script workflow intact.
